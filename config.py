...
# NAMA OWNER
OWNER = os.environ.get("OWNER", "@Arkan1789")
...
# Username CH & Group
CHANNEL = os.environ.get("CHANNEL", "dinomerah_desahh")
...
FORCE_SUB_GROUP = int(os.environ.get("FORCE_SUB_GROUP", "dinomerahdesah"))
...
try:
    ADMINS = [int(x) for x in (os.environ.get("ADMINS", "7318300249").split())]
except ValueError:
